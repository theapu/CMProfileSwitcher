...
//	    microphone - 1 if headset has a microphone, 0 otherwise
		...
		ProfileSwitcher.myLog("in HeadsetBroadcastReceiver - onReceive - intent.getAction: " + intent.getAction() + 
				...
				" - state:" + state);
		ProfileSwitcher.myLog("in HeadsetBroadcastReceiver - onReceive - resetOnHeadsetPlug = "
				+ profileSwitcher.resetOnHeadsetPlug()
				+ ", resetOnHeadsetUnplug = " +profileSwitcher.resetOnHeadsetUnplug() );

		ProfileSwitcher.myLog("in HeadsetBroadcastReceiver - onReceive - context.getPackageName() = "
